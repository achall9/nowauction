...
use Ced\CsProduct\Controller\Vproducts\Save;
...
class ProcessSourceItem implements ObserverInterface
{
    /**
     ...
     * @return array
     */
    private function getSourceItemsWithoutDefault(string $sku)
    {
