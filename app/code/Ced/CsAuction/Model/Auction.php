...
{
    CONST AUCTION_COMPLETE = 'complete';
    CONST AUCTION_PROCESSING = 'processing';
    CONST AUCTION_CLOSED = 'closed';
    CONST AUCTION_CANCELLED = 'cancelled';
    ...
    {
        $this->_init('Ced\CsAuction\Model\ResourceModel\Auction');
    }
