...
class AuctionForm extends \Ced\CsMarketplace\Model\FlatAbstractModel
{
    ...
    {
        $this->_fields = array();
        $this->_fields['product_name'] = array('type' => 'text', 'required' => false);
        $this->_fields['price'] = array('type' => 'text', 'required' => false);
        $this->_fields['starting_price'] = array('type' => 'text', 'required' => true);
        $this->_fields['max_price'] = array('type' => 'text', 'required' => true);
        $this->_fields['start_datetime'] = array('type' => 'text', 'required' => true);
        $this->_fields['end_datetime'] = array('type' => 'text', 'required' => true);
        $this->_fields['extended_time'] = array('type' => 'text', 'required' => false);
        $this->_fields['status'] = array('type' => 'select', 'required' => false,
