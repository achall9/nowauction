...
class AuctionList extends \Magento\Backend\Block\Widget\Container
{
    public $_template = 'auctionlist.phtml';
    /**
    ...
    public function _prepareLayout()
    {
        $addButtonProps = [
            ...
            'class' => 'add',
            'button_class' => 'Ced\CsProduct\Block\Widget\Button\SplitButton',
            'onclick' => "setLocation('" . $this->_getCreateUrl('csauction/addauction/index') . "')"
        ...
        $this->setChild(
            'grid',
            $this->getLayout()->createBlock('Ced\CsAuction\Block\AuctionList\Grid', 'ced.csauction.vendor.auction.grid')
        );
