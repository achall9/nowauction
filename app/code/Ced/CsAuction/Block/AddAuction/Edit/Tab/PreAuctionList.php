...
class PreAuctionList extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = $this->resourceBidDetails->create()->addFieldToFilter('product_id',$productId)->addFieldToFilter('is_preauction',1);
