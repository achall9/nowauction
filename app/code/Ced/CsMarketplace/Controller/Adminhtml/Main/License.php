...
class License extends \Magento\Backend\App\Action
{
    ...
    public function checkLicense(){
        ...
        if(trim($this->getModules())!=''){
            if($this->csmarketplaceHelper->getStoreConfig('ced/csmarketplace/islicensevalid'))
            {
                $this->csmarketplaceHelper->setStoreConfig('ced/csmarketplace/islicensevalid',0);
            }
        }
        else
        {
            $this->csmarketplaceHelper->setStoreConfig('ced/csmarketplace/islicensevalid',1);
        }
    }
}
