...
class Addorder extends \Magento\Backend\Block\Template
{
  /**
    ...
    /**
     * @var \Ced\CsMarketplace\Block\Adminhtml\Vorders\Grid\Renderer\Orderid
     */
    protected $orderid;
  ...
  public function getSearchFormHtml() {
    ...
    $fieldset->addField('csmarketplace_vendor_total', 'text', array(
                ...
                'readonly'  => 'readonly',
                'after_element_html' => '<b>['.$this->directoryHelper->getBaseCurrencyCode().']</b><small><i> Readonly field</i>.</small>',
                ));
