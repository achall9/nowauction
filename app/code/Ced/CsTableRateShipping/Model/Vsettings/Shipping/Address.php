...
/**
 * Class Address
 * @package Ced\CsTableRateShipping\Model\Vsettings\Shipping
 */
class Address extends \Ced\CsMarketplace\Model\FlatAbstractModel
{
    ...
    {
        $this->_fields = array();
        $this->_fields['country_id'] = array('type' => 'select', 'required' => true,
            'values' => $this->country->toOptionArray());
        $this->_fields['region_id'] = array('type' => 'select', 'required' => true,
            'values' => array(array('label' => __('Please select region, state or province'), 'value' => '')));
        ...
        $this->_fields['condition_name'] = array('type' => 'select',
            'values' => $this->tablerate->toOptionArray());
        $this->_fields['condition_value'] = array('type' => 'text', 'required' => true, 'class' => 'validate-number');
        $this->_fields['price'] = array('type' => 'text', 'required' => true, 'class' => 'validate-number');
        return $this->_fields;
    }
    ...
    public function getLabel($key)
    {
        switch ($key) {
            ...
            case 'postcode' :
                ...
                break;
            case 'condition_name' :
                return __('Condition Name');
                break;
            case 'condition_value' :
                return __('Condition Value');
                break;
            case 'dest_zip' :
                return __('Destination ZIP Code');
                break;
            case 'price' :
                return __('Price');
                break;
