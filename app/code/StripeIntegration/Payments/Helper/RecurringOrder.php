...
class RecurringOrder
{
    ...
    public function reOrder($originalOrder, $invoiceDetails)
    {
        ...
        $this->setQuotePaymentMethodFrom($originalOrder, $quote, $invoiceDetails);
    ...
    public function setQuotePaymentMethodFrom($originalOrder, &$quote, $invoiceDetails)
    {
        $quote->setPaymentMethod($originalOrder->getPayment()->getMethod());
        $quote->setInventoryProcessed(false);
        $quote->save(); // Needed before setting payment data
        $quote->getPayment()
            ->importData(['method' => $originalOrder->getPayment()->getMethod()])
